...
public class EmpresaSpecification {
    ...
    public static Specification<Empresa> filtrarEmpresas(String nome, String cnpj, String razaoSocial){
        return (Root<Empresa> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) -> {
